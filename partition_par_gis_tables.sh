...
psql -h $host -U postgres -c "CREATE TABLE ${table}_p3 PARTITION OF ${table} FOR VALUES FROM ('2017-08-27') TO ('2017-08-28')" ei
psql -h $host -U postgres -c "CREATE TABLE ${table}_p4 PARTITION OF ${table} FOR VALUES FROM ('2017-08-28') TO ('2017-08-29')" ei
